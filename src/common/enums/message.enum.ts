...
export enum AuthMassege{
  ...
  BlockUser="حساب کاربری شما مسدود میباشد لطفا با پشتیبانی تماس حاصل نمایید"
}
export enum PublicMassege{
  ...
  CommentBlog="دیدگاه با موفقیت ایجاد شد",
  RiportComment="دیدگاه حاوی کلمات رکیک میباشد لطفا اصلاح شود",
  Follow="با موفقیت به لیست دنبال شوندگان اضافه شد",
  Unfollow="کاربر از لیست دنبال کنندگان حذف شد",
  Block="کاربر به لیست مسدود اضافه شد",
  Unblock="کاربر از لیست مسدود حذف شد"
